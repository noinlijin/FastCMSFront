goog.provide("fastcms.js.Dashboard");
goog.require("plugin.jquery.Jquery");

goog.require("plugin.skycons.Skycons");
goog.require("fastcms.js.JqueryCustomSelect");
...
$(function(){
    ...
    if (Gauge) {
        ...
        var target = document.getElementById('gauge'); // your canvas
